  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute z-0" style={{top: '20px', left: '20px'}}>
        ...
        <div className="absolute z-0" style={{top: '20px', right: '20px'}}>
          <div className="relative">
        ...
        <div className="absolute hidden md:block z-0" style={{bottom: '200px', left: '20px'}}>
          <div className="relative">
        ...
        <div className="absolute hidden md:block z-0" style={{bottom: '200px', right: '20px'}}>
          <div className="relative">
